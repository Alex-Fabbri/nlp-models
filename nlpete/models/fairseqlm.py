...
#                            args.decoder_input_dim, args.adaptive_input_factor, args.decoder_embed_dim, \
#                             options.eval_str_list(args.adaptive_input_cutoff, type=int))
#        else:
#            embed_tokens = Embedding(vocab.get_vocab_size(), self.decoder_input_dim, \
#                            vocab.get_token_index(DEFAULT_PADDING_TOKEN))
#
...
#        self.decoder = TransformerDecoder(args,  fairseq_dict, embed_tokens, \
#                        no_encoder_attn=True, final_norm=False)
#
#
