...
class CNNDMMem2SeqDatasetReader(DatasetReader):
    """
    ...
    def _create_target_to_source_sentinel_array(tokenized_source: List[Token],
        ...
        target_to_source_array.insert(0, [0])
        target_to_source_array.append([0])
        return np.array(target_to_source_array)
    ...
    def text_to_instance(self, source_string: str, target_string: str = None) -> Instance:  # type: ignore
        ...
        if target_string is not None:
            ...
            target_to_source_sentinel_array = self._create_target_to_source_sentinel_array(tokenized_source, tokenized_target)
